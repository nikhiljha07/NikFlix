...
<?php 
             ...
             $username = "";
              ...
              $db = mysqli_connect('localhost', 'root', '', 'nikflix');
                  ...
                  $sql= "SELECT tv_series.tv_id,tv_series.tv_name,tv_series.genre,tv_series.year_of_release,tv_series.season FROM tv_series,users WHERE users.user_id='$email' and users.tv_id=tv_series.tv_id;";
                  ...
                  if (mysqli_num_rows($results) > 0)
                  {
                      while($row= mysqli_fetch_assoc($results))
                      {
                        ...
                        $season=$row["season"];
                         ...
                         echo  "<tr><td>" . $tv_id."</td><td>". $tv_name ."</td><td>" .$genre ."</td><td>" .$year_of_release. "</td><td>" .$season ."</td></tr>";
                      } 
                      echo "</table>";  
